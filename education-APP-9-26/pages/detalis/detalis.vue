<template>
	<view class="return" @click="index"><uni-icons type="back" size="30" color="#fff"></uni-icons></view>
	<view class="herade">
		<!-- 详情 -->
	...
	<view v-show="active == 2">
		<view class="jie" v-for="item in pingData" :key="item.id">
			<view class="jie1">
				<view class="img"><image :src="item.userImage == null ? '../../static/tab/my.png' : item.userImage"></image></view>
				<view class="jie2">
					<p>{{ item.nickName }}</p>
					<p>{{ item.createDate }}</p>
				</view>
	...
	<view class="guankan"><button @click="add3">立即观看</button></view>
</template>
